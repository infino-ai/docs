---
title: Tutorials
description: Runnable, end-to-end examples — RAG, agent memory, hybrid search, code search, analytics, and more.
---
...
<CardGroup cols={2}>
  ...
  <Card title="Hybrid search service" icon="magnifying-glass" href="https://github.com/infino-ai/infino/tree/main/infino-node/examples/hybrid-search-api">
    An embedded BM25 + vector search API over a product catalog — no separate search
    server. **Node.js**.
  </Card>
...
Framework walkthroughs — [LangChain](https://github.com/infino-ai/infino/tree/main/infino-python/examples/langchain)
and [CrewAI](https://github.com/infino-ai/infino/tree/main/infino-python/examples/crewai) —
are covered in [Integrations](/integrations).
