---
title: "Local vs Infino Cloud"
icon: "table-columns"
description: Which operations are available on a local Infino connection versus Infino Cloud, and where behavior differs.
---
...
See the hosted [Quickstart](/cloud/quickstart) and
[Authentication](/cloud/authentication) for the connection details, and the
