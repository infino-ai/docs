---
title: Integrations with LangChain, AI SDK, CrewAI, and MCP
icon: "puzzle-piece"
description: Plug Infino retrieval into your stack with official integrations for LangChain, the Vercel AI SDK, CrewAI, and the Model Context Protocol (MCP).
---
