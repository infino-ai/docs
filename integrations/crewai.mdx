...
icon: "users"
description: Give CrewAI agents retrieval over your own data with Infino — expose BM25, vector, hybrid, and SQL search as tools your crew can call during tasks.
---
