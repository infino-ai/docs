...
title: SQL Reference
icon: "database"
description: Query Infino with SQL via query_sql — the supported dialect, the bm25_search, vector_search, and hybrid_search table functions, and how to compose them.
---
