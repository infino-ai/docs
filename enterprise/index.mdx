...
<Note>
  **Coming soon.** Infino Enterprise is not generally available yet — this documents the
  hosted service ahead of launch, so the endpoint and sign-up may not be live.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Security & Compliance" icon="shield" href="/enterprise/security">
    Auth, encryption, tenant isolation, and key rotation.
  </Card>
</CardGroup>
