---
title: Quickstart
description: Index a small knowledge base and retrieve over it three ways — BM25 keyword, vector kNN, and SQL — over one table, in Python, Node.js, or Rust.
---
...
Each search returns Arrow rows. From here, feed the retrieved passages to your model
as grounding context — see the [concepts](/concepts/retrieval-for-agents) for how the
three retrieval modes fit an agent loop.
