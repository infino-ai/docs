---
title: "Core concepts: how Infino indexes and queries Parquet"
icon: "diagram-project"
description: How Infino works. One copy of your data as Apache Parquet with built-in search indexes, queryable four ways (full-text, vector, SQL, hybrid) in-process.
---
