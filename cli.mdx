...
Point `--uri` at your `https://api.platform.infino.ai/<database>` URL and pass an
...
infino create-database --uri https://api.platform.infino.ai/my-app
infino bm25-search docs body "object storage" -k 10 --uri https://api.platform.infino.ai/my-app
```
