...
title: Tables
icon: "table"
description: Manage Infino tables — define schemas, append rows, update and delete by predicate, compact Parquet files, and inspect the table catalog.
---
...
| `min_fill_percent` / `minFillPercent` | only compact superfiles below this fill percent (0–100) |
