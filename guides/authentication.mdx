...
Requests to [Infino Cloud](/guides/hosted) are authenticated with an **API key**. This
...
```python Python icon="python"
db = infino.connect("https://<your-endpoint>/my-app")
```

```typescript Node.js icon="node-js"
const db = connect("https://<your-endpoint>/my-app");
```

```rust Rust icon="rust"
let db = connect("https://<your-endpoint>/my-app")?;
```
...
- [Infino Cloud](/guides/hosted) — connect, provision a database, and run your first search.
