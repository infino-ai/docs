...
icon: "file-export"
description: Infino stores your data as standard Apache Parquet — read tables directly from DuckDB, pandas, or pyarrow with no export step and no Infino runtime.
---
