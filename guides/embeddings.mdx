---
title: "Embeddings: bring your own vectors to Infino"
icon: "vector-square"
...
text = "Refunds return to the original payment method."
...
const text = "Refunds return to the original payment method.";
...
let spec = IndexSpec::new().fts("body").vector("embedding", 384, Metric::Cosine);
```
