...
[platform.infino.ai](https://platform.infino.ai) — the only place keys are minted (there
...
Rotate a leaked or expiring key in the [console](https://platform.infino.ai). Create a new key, roll it out to
