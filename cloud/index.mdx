...
title: "Infino Cloud"
icon: "building"
description: Infino Cloud is the Infino retrieval engine served as a fully-managed, object-storage-native hosted service. No servers to run or size, usage-based, same API as the open-source engine.
---
...
the `connect` target. See the [Quickstart](/cloud/quickstart) for the one-line change.
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="cloud" href="/cloud/quickstart">
  ...
  <Card title="Architecture" icon="sitemap" href="/cloud/architecture">
